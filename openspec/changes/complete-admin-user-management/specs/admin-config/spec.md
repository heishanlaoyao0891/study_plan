...
- **THEN** system returns user list with basic info including login username, nickname, and OpenID
...
- **THEN** the console shows distinct login username, nickname, and OpenID columns and provides a clear add-user entry to the invitation workflow
