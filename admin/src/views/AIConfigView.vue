<template>
  <main class="workspace">
    <section class="page-head"><div><p class="eyebrow">智能生成</p><h2>AI 配置</h2><p class="page-note">SiliconFlow 使用 OpenAI 兼容接口，推荐 deepseek-ai/DeepSeek-V3.2。连接测试会验证完整的结构化计划输出。</p></div></section>
